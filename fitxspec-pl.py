...
Fit.query = "yes"
Fit.perform()
alpha = m.powerlaw.PhoIndex.values[0]
alpha_err = m.powerlaw.PhoIndex.sigma
norm = m.powerlaw.norm.values[0]
norm_err = m.powerlaw.norm.sigma
...
plt.savefig("spectrum-pl_%04i.pdf"%i)
plt.close(f)

print("%04i"%i, alpha, alpha_err, norm, norm_err, chi2, dof, redchi2, nullhyp, fluxes['20_100'],fluxes_ph['20_100'], fluxes['20_40'], fluxes_ph['20_40'], fluxes['40_100'], fluxes_ph['40_100'])
