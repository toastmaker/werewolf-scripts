...
kT_err = m.bremss.kT.sigma
norm = m.bremss.norm.values[0]
norm_err = m.bremss.norm.sigma
...
plt.savefig("spectrum-bremss_%04i.pdf"%i)
plt.close(f)

print("%04i"%i, kT, kT_err, norm, norm_err, chi2, dof, redchi2, nullhyp, fluxes['20_100'],fluxes_ph['20_100'], fluxes['20_40'], fluxes_ph['20_40'], fluxes['40_100'], fluxes_ph['40_100'])
